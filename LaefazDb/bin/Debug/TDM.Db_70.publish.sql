...
GO
ALTER TABLE [dbo].[Execucao] DROP CONSTRAINT [DF__tmp_ms_xx__Envio__2DE6D218];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Execucao] ([Id], [IdScript_CondicaoScript_Ambiente], [IdTestData], [IdAgendamento], [IdStatusExecucao], [IdTipoFaseTeste], [Usuario], [SituacaoAmbiente], [InicioExecucao], [TerminoExecucao], [ToscaInput], [ToscaOutput], [EnvioTelegram])
        SELECT   [Id],
