...
INSERT INTO Script_CondicaoScript (IdScript, IdCondicaoScript, NomeTecnicoScript, ListaExecucaoTosca, CaminhoArquivoTCS, DiretorioRelatorio, QueryTosca)   
(SELECT scr.Id, NULL,'CRIAR_PEDIDO_SBL8_REALIZAR_PEDIDO', '/Execution/ExecutionLists/CRIAR_PEDIDO_SBL8_REALIZAR_PEDIDO','C:\Tosca_Projects\Tosca_Workspaces\TDM\remote_exec\criar-pedido-sbl8-realizar_pedido.tcs','C:/Tosca_Projects/Tosca_Workspaces/TDM/remote_exec/Reports/report.txt', 
...
INSERT INTO Script_CondicaoScript (IdScript, IdCondicaoScript, NomeTecnicoScript, ListaExecucaoTosca, CaminhoArquivoTCS, DiretorioRelatorio, QueryTosca)   
(SELECT scr.Id, NULL, 'CONTATO_E_CONTA_PF_SEM_ENVIO_CDI', '/Execution/ExecutionLists/CONTATO_E_CONTA_PF_SEM_ENVIO_CDI','C:\Tosca_Projects\Tosca_Workspaces\TDM\remote_exec\contato-e-conta-pf-sem-envio-cdi.tcs','C:/Tosca_Projects/Tosca_Workspaces/TDM/remote_exec/Reports/report.txt', 
...
INSERT INTO Script_CondicaoScript (IdScript, IdCondicaoScript, NomeTecnicoScript, ListaExecucaoTosca, CaminhoArquivoTCS, DiretorioRelatorio, QueryTosca)   
(SELECT scr.Id, NULL, 'INCLUSAO_DE_CLIENTE_PF_NO_STC','/Execution/ExecutionLists/INCLUSAO_DE_CLIENTE_PF_NO_STC','C:\Tosca_Projects\Tosca_Workspaces\TDM\remote_exec\inclusao-de-cliente-pf-no-stc.tcs','C:/Tosca_Projects/Tosca_Workspaces/TDM/remote_exec/Reports/report.txt', 
'SELECT DISTINCT top 10000 tdt.Id AS ID_TEST_DATA,
					scr.Descricao AS SCRIPT,
					dem.Descricao AS DEMANDA,
					tdt.CasoTesteRelativo AS CASO_TESTE,
...
INSERT INTO Script_CondicaoScript (IdScript, IdCondicaoScript, NomeTecnicoScript, ListaExecucaoTosca, CaminhoArquivoTCS, DiretorioRelatorio, QueryTosca)  
(SELECT scr.Id, NULL, 'CRIAR_PEDIDO_SBL8_CRIAR_ENDERECO', '/Execution/ExecutionLists/CRIAR_PEDIDO_SBL8_CRIAR_ENDERECO','C:\Tosca_Projects\Tosca_Workspaces\TDM\remote_exec\criar-pedido-sbl8-criar-endereco.tcs','C:/Tosca_Projects/Tosca_Workspaces/TDM/remote_exec/Reports/report.txt',
...
INSERT INTO Script_CondicaoScript (IdScript, IdCondicaoScript, NomeTecnicoScript, ListaExecucaoTosca, CaminhoArquivoTCS, DiretorioRelatorio, QueryTosca)  
(SELECT scr.Id, NULL,'CRIAR_PEDIDO_SBL8_CRIAR_CONTATO', '/Execution/ExecutionLists/CRIAR_PEDIDO_SBL8_CRIAR_CONTATO','C:\Tosca_Projects\Tosca_Workspaces\TDM\remote_exec\criar-pedido-sbl8-criar-contato.tcs','C:/Tosca_Projects/Tosca_Workspaces/TDM/remote_exec/Reports/report.txt',
...
INSERT INTO Script_CondicaoScript (IdScript, IdCondicaoScript, NomeTecnicoScript, ListaExecucaoTosca, CaminhoArquivoTCS, DiretorioRelatorio, QueryTosca)  
(SELECT scr.Id, NULL,'CRIAR_PEDIDO_SBL8_CRIAR_PERFIL_FATURAMENTO', '/Execution/ExecutionLists/CRIAR_PEDIDO_SBL8_CRIAR_PERFIL_FATURAMENTO','C:\Tosca_Projects\Tosca_Workspaces\TDM\remote_exec\criar-pedido-sbl8-criar-perfil-faturamento.tcs','C:/Tosca_Projects/Tosca_Workspaces/TDM/remote_exec/Reports/report.txt',
...
INSERT INTO Script_CondicaoScript (IdScript, IdCondicaoScript, NomeTecnicoScript, ListaExecucaoTosca, CaminhoArquivoTCS, DiretorioRelatorio, QueryTosca)  
(SELECT scr.Id, NULL, 'CRIAR_PEDIDO_SBL8_REALIZAR_ANALISE_DE_CREDITO','/Execution/ExecutionLists/CRIAR_PEDIDO_SBL8_REALIZAR_ANALISE_DE_CREDITO','C:\Tosca_Projects\Tosca_Workspaces\TDM\remote_exec\criar-pedido-sbl8-realizar-analise-de-credito.tcs','C:/Tosca_Projects/Tosca_Workspaces/TDM/remote_exec/Reports/report.txt',
 'SELECT DISTINCT top 10000 tdt.Id AS ID_TEST_DATA,
					scr.Descricao AS SCRIPT,
					dem.Descricao AS DEMANDA,
					tdt.CasoTesteRelativo AS CASO_TESTE,
...
INSERT INTO Script_CondicaoScript (IdScript, IdCondicaoScript, NomeTecnicoScript, ListaExecucaoTosca, CaminhoArquivoTCS, DiretorioRelatorio, QueryTosca)  
(SELECT scr.Id, NULL,'AJA_CADASTRA_ALTERAR_CLIENTE', '/Execution/ExecutionLists/AJA_CADASTRA_ALTERAR_CLIENTE','C:\Tosca_Projects\Tosca_Workspaces\TDM\remote_exec\aja-cadastra-altera-cliente.tcs','C:/Tosca_Projects/Tosca_Workspaces/TDM/remote_exec/Reports/report.txt',
