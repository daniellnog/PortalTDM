...
GO
ALTER TABLE [dbo].[Execucao] DROP CONSTRAINT [DF__Execucao__EnvioT__6D0D32F4];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Execucao] ([Id], [IdScript_CondicaoScript_Ambiente], [IdTestData], [IdStatusExecucao], [IdTipoFaseTeste], [Usuario], [SituacaoAmbiente], [DataAgendamento], [InicioExecucao], [TerminoExecucao], [ToscaInput], [ToscaOutput], [EnvioTelegram])
        SELECT   [Id],
