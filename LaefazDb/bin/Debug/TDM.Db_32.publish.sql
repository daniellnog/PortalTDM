...
INSERT INTO Script (IdAUT, Descricao, NomeTecnicoScript)
(SELECT Id, 'CRIAÇÃO DE CONTATO E CONTA PF SEM ENVIO AO CDI', 'CONTATO_E_CONTA_PF_SEM_ENVIO_CDI' FROM AUT WHERE Descricao = 'SIEBEL 6.3');

INSERT INTO Script (IdAUT, Descricao, NomeTecnicoScript)
(SELECT Id, 'CRIAR ANÁLISE DE CRÉDITO', 'CRIAR_PEDIDO_SBL8_REALIZAR_ANALISE_DE_CREDITO' FROM AUT WHERE Descricao = 'SIEBEL 8');

INSERT INTO Script (IdAUT, Descricao, NomeTecnicoScript)
(SELECT Id, 'CRIAR PERFIL DE FATURAMENTO', 'CRIAR_PEDIDO_SBL8_CRIAR_PERFIL_FATURAMENTO' FROM AUT WHERE Descricao = 'SIEBEL 8');

INSERT INTO Script (IdAUT, Descricao, NomeTecnicoScript)
(SELECT Id, 'REALIZAR CRIAÇÃO DE CONTATO', 'CRIAR_PEDIDO_SBL8_CRIAR_ENDERECO' FROM AUT WHERE Descricao = 'SIEBEL 8');

INSERT INTO Script (IdAUT, Descricao, NomeTecnicoScript)
(SELECT Id, 'REALIZAR INCLUSÃO DE ENDEREÇO FIBRA', 'CRIAR_PEDIDO_SBL8_CRIAR_CONTATO' FROM AUT WHERE Descricao = 'SIEBEL 8');

INSERT INTO Script (IdAUT, Descricao, NomeTecnicoScript)
(SELECT Id, 'REALIZAR PEDIDO', 'CRIAR_PEDIDO_SBL8_REALIZAR_PEDIDO' FROM AUT WHERE Descricao = 'SIEBEL 8');

INSERT INTO Script (IdAUT, Descricao, NomeTecnicoScript)
(SELECT Id, 'INCLUSÃO DE CLIENTE PF NO STC', 'INCLUSAO_DE_CLIENTE_PF_NO_STC' FROM AUT WHERE Descricao = 'STC');
             
INSERT INTO Script (IdAUT, Descricao, NomeTecnicoScript)
(SELECT Id, 'AJA - CADASTRA - ALTERAR CLIENTE', 'AJA_CADASTRA_ALTERAR_CLIENTE' FROM AUT WHERE Descricao = 'SAC');
