...
ALTER TABLE [dbo].[DataPool]
    ADD [ConsiderarRotinaDiaria] BIT DEFAULT 0 NOT NULL;
...
GO
ALTER PROCEDURE PR_LISTAR_AMBIENTE_EXECUCAO
	@ID_SCRIPT_CONDICAOSCRIPT NVARCHAR(255) = NULL
AS
BEGIN
	SELECT Distinct(ae.[Id])
      ,ae.[Descricao]
  FROM [dbo].[AmbienteExecucao] ae
  INNER JOIN [dbo].Script_CondicaoScript_Ambiente sca on ae.Id = sca.IdAmbienteExecucao
  INNER JOIN [dbo].Script_CondicaoScript scs on sca.IdScript_CondicaoScript = scs.Id
  WHERE scs.Id = @ID_SCRIPT_CONDICAOSCRIPT OR @ID_SCRIPT_CONDICAOSCRIPT IS NULL
...
GO
PRINT N'Refreshing [dbo].[PR_LISTAR_DATAPOOL_COM_TESTDATA]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[PR_LISTAR_DATAPOOL_COM_TESTDATA]';
...
GO
PRINT N'Refreshing [dbo].[PR_LISTAR_TESTDATA]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[PR_LISTAR_TESTDATA]';
