...
ALTER TABLE [dbo].[tmp_ms_xx_Encadeamento_TestData]
    ADD CONSTRAINT [SD_Encadeamento_TestData_2534dca2259a47f9a5dbd9814017f62b] DEFAULT 0 FOR [IdEncadeamento];
...
ALTER TABLE [dbo].[tmp_ms_xx_Encadeamento_TestData] DROP CONSTRAINT [SD_Encadeamento_TestData_2534dca2259a47f9a5dbd9814017f62b];
...
UPDATE [dbo].[Script_CondicaoScript]
SET    [TempoEstimadoExecucao] = CONVERT(DateTime, '')
WHERE  [TempoEstimadoExecucao] IS NULL;
