...
GO
PRINT N'Creating [dbo].[Agendamento]...';
...
GO
PRINT N'Creating [dbo].[FK_Agendamento_TestData_Agendamento]...';


GO
ALTER TABLE [dbo].[Agendamento_TestData] WITH NOCHECK
    ADD CONSTRAINT [FK_Agendamento_TestData_Agendamento] FOREIGN KEY ([IdAgendamento]) REFERENCES [dbo].[Agendamento] ([Id]);
...
ALTER TABLE [dbo].[Agendamento_TestData] WITH CHECK CHECK CONSTRAINT [FK_Agendamento_TestData_Agendamento];
