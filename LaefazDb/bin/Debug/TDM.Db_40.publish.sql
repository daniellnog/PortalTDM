...
GO
ALTER TABLE [dbo].[Execucao] DROP CONSTRAINT [DF__Execucao__EnvioT__5FB337D6];
...
GO
ALTER TABLE [dbo].[Execucao] ALTER COLUMN [EnvioTelegram] BIT NOT NULL;

ALTER TABLE [dbo].[Execucao] ALTER COLUMN [ToscaOutput] VARCHAR (MAX) NULL;
