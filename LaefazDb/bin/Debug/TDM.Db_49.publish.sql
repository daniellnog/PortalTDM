...
GO
/*
The column [dbo].[Agendamento_TestData].[Ordem] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[Agendamento_TestData])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Altering [dbo].[Agendamento_TestData]...';


GO
ALTER TABLE [dbo].[Agendamento_TestData] DROP COLUMN [Ordem];
