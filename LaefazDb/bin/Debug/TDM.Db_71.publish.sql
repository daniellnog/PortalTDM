...
ALTER TABLE [dbo].[tmp_ms_xx_Encadeamento_TestData]
    ADD CONSTRAINT [SD_Encadeamento_TestData_b3517813d6f34555b94c67672367055d] DEFAULT 0 FOR [IdAmbienteExecucao];

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Encadeamento_TestData])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_Encadeamento_TestData] ON;
        INSERT INTO [dbo].[tmp_ms_xx_Encadeamento_TestData] ([Id], [IdTestData], [IdEncadeamento], [Ordem])
        SELECT   [Id],
                 [IdTestData],
                 [IdEncadeamento],
                 [Ordem]
...
ALTER TABLE [dbo].[tmp_ms_xx_Encadeamento_TestData] DROP CONSTRAINT [SD_Encadeamento_TestData_b3517813d6f34555b94c67672367055d];
...
GO
PRINT N'Creating [dbo].[FK_AmbienteExecucao_TestData_Encadeamento]...';


GO
ALTER TABLE [dbo].[Encadeamento_TestData] WITH NOCHECK
    ADD CONSTRAINT [FK_AmbienteExecucao_TestData_Encadeamento] FOREIGN KEY ([IdAmbienteExecucao]) REFERENCES [dbo].[AmbienteExecucao] ([Id]);
...
ALTER TABLE [dbo].[Encadeamento_TestData] WITH CHECK CHECK CONSTRAINT [FK_AmbienteExecucao_TestData_Encadeamento];
