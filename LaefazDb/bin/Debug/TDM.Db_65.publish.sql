...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Agendamento] ([Id], [InicioAgendamento], [TerminoAgendamento], [Output])
        SELECT   [Id],
                 [InicioAgendamento],
                 [TerminoAgendamento],
                 [Output]
...
GO
PRINT N'Refreshing [dbo].[PR_LISTAR_DATAPOOL_SEM_USUARIO]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[PR_LISTAR_DATAPOOL_SEM_USUARIO]';
