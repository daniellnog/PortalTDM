...
IF EXISTS (select top 1 1 from [dbo].[Agendamento])
...
GO
PRINT N'Dropping [dbo].[FK_Agendamento_TestData_TestData]...';


GO
ALTER TABLE [dbo].[Agendamento] DROP CONSTRAINT [FK_Agendamento_TestData_TestData];


GO
PRINT N'Altering [dbo].[Agendamento]...';


GO
ALTER TABLE [dbo].[Agendamento] DROP COLUMN [IdTestData];
...
GO
PRINT N'Creating [dbo].[Agendamento_TestData]...';
...
CREATE TABLE [dbo].[Agendamento_TestData] (
    ...
    [IdTestData]    INT NOT NULL,
    CONSTRAINT [PK_Agendamento_TestData] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
PRINT N'Creating [dbo].[Agendamento_TestData].[IX_Agendamento_TestData_IdTestData]...';


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_Agendamento_TestData_IdTestData]
    ON [dbo].[Agendamento_TestData]([IdTestData] ASC);
...
GO
PRINT N'Creating [dbo].[FK_Agendamento_TestData_TestData]...';


GO
ALTER TABLE [dbo].[Agendamento_TestData] WITH NOCHECK
    ADD CONSTRAINT [FK_Agendamento_TestData_TestData] FOREIGN KEY ([IdTestData]) REFERENCES [dbo].[TestData] ([Id]);
...
ALTER TABLE [dbo].[Agendamento_TestData] WITH CHECK CHECK CONSTRAINT [FK_Agendamento_TestData_TestData];
