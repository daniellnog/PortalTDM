...
GO
PRINT N'Creating [dbo].[Encadeamento]...';


GO
CREATE TABLE [dbo].[Encadeamento] (
    [Id]        INT          IDENTITY (1, 1) NOT NULL,
...
GO
PRINT N'Creating [dbo].[Encadeamento_TestData]...';
...
CREATE TABLE [dbo].[Encadeamento_TestData] (
    ...
    [Ordem]          INT NOT NULL,
    CONSTRAINT [PK_Encadeamento_TestData] PRIMARY KEY CLUSTERED ([Id] ASC)
);
...
CREATE TABLE [dbo].[ParametroScript] (
    ...
    [VisivelEmTela]           BIT            NOT NULL,
    PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
PRINT N'Creating [dbo].[ParametroScript_Valor]...';
...
GO
PRINT N'Creating [dbo].[ParametroValor_Historico]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[ParametroScript]...';


GO
ALTER TABLE [dbo].[ParametroScript]
    ADD DEFAULT 1 FOR [VisivelEmTela];
...
GO
ALTER TABLE [dbo].[TestData]
    ADD DEFAULT '2001-01-01 00:00:00.000' FOR [TempoEstimadoExecucao];
...
GO
ALTER TABLE [dbo].[Encadeamento_TestData]
...
GO
PRINT N'Creating [dbo].[FK_ParametroScript_Valor_ParametroScript]...';


GO
ALTER TABLE [dbo].[ParametroScript_Valor]
    ADD CONSTRAINT [FK_ParametroScript_Valor_ParametroScript] FOREIGN KEY ([IdParametroScript]) REFERENCES [dbo].[ParametroScript] ([Id]);
...
GO
PRINT N'Creating [dbo].[FK_ParametroValor_Historico_ParametroValor]...';


GO
ALTER TABLE [dbo].[ParametroValor_Historico]
    ADD CONSTRAINT [FK_ParametroValor_Historico_ParametroValor] FOREIGN KEY ([IdParametroValor]) REFERENCES [dbo].[ParametroValor] ([Id]);
...
GO
PRINT N'Creating [dbo].[PR_LISTAR_AMBIENTE_EXECUCAO]...';


GO
CREATE PROCEDURE PR_LISTAR_AMBIENTE_EXECUCAO
	@IDTESTDATA NVARCHAR(255) = NULL
AS
BEGIN
	SELECT Distinct(ae.[Id])
      ,ae.[Descricao]
  FROM [TDM.Db].[dbo].[AmbienteExecucao] ae
  INNER JOIN [TDM.Db].[dbo].Script_CondicaoScript_Ambiente sca on ae.Id = sca.IdAmbienteExecucao
  INNER JOIN [TDM.Db].[dbo].TestData td on sca.IdScript_CondicaoScript = td.IdScript_CondicaoScript
  WHERE td.Id = @IDTESTDATA OR @IDTESTDATA IS NULL

	
END
GO
PRINT N'Creating [dbo].[PR_LISTAR_AMBIENTE_VIRTUAL_DISPONIVEL]...';
...
END
GO
PRINT N'Creating [dbo].[PR_LISTAR_DADOS_EXECUCAO]...';
...
END
GO
PRINT N'Creating [dbo].[PR_LISTAR_DATAPOOL_COM_TESTDATA]...';
...
END
GO
PRINT N'Creating [dbo].[PR_LISTAR_ENCADEAMENTO]...';
...
END
GO
PRINT N'Creating [dbo].[PR_LISTAR_EXECUCAO]...';
...
END
GO
PRINT N'Creating [dbo].[PR_LISTAR_TESTDATA]...';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'b5373bff-eeb0-4261-b040-6bc2a106595b')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('b5373bff-eeb0-4261-b040-6bc2a106595b')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '1a14c2f9-7d0d-4dab-81ca-96446cf564a4')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('1a14c2f9-7d0d-4dab-81ca-96446cf564a4')
