/*
Deployment script for DevTDM.Db
...
GO
:setvar DatabaseName "DevTDM.Db"
:setvar DefaultFilePrefix "DevTDM.Db"
...
IF EXISTS (select top 1 1 from [dbo].[Encadeamento_TestData])
...
IF EXISTS (select top 1 1 from [dbo].[Execucao])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'The following operation was generated from a refactoring log file 92177cad-6b15-42b2-9a4d-01c1962f6b96';

PRINT N'Rename [dbo].[Encadeamento_TestData].[IdTestData] to IdAgendamento';


GO
EXECUTE sp_rename @objname = N'[dbo].[Encadeamento_TestData].[IdTestData]', @newname = N'IdAgendamento', @objtype = N'COLUMN';


GO
PRINT N'The following operation was generated from a refactoring log file b28251b9-0f0f-4ef7-9899-b8115aff1f24';

PRINT N'Rename [dbo].[Encadeamento_TestData].[IdEncadeamento] to IdTestData';


GO
EXECUTE sp_rename @objname = N'[dbo].[Encadeamento_TestData].[IdEncadeamento]', @newname = N'IdTestData', @objtype = N'COLUMN';


GO
PRINT N'Dropping unnamed constraint on [dbo].[Execucao]...';


GO
ALTER TABLE [dbo].[Execucao] DROP CONSTRAINT [DF__tmp_ms_xx__Envio__793DFFAF];


GO
PRINT N'Dropping [dbo].[FK_Encadeamento_TestData_TestData]...';


GO
ALTER TABLE [dbo].[Encadeamento_TestData] DROP CONSTRAINT [FK_Encadeamento_TestData_TestData];


GO
PRINT N'Dropping [dbo].[FK_Encadeamento_TestData_Encadeamento]...';


GO
ALTER TABLE [dbo].[Encadeamento_TestData] DROP CONSTRAINT [FK_Encadeamento_TestData_Encadeamento];
...
GO
PRINT N'Dropping [dbo].[FK_Agendamento_Execucao]...';


GO
ALTER TABLE [dbo].[Execucao] DROP CONSTRAINT [FK_Agendamento_Execucao];
...
GO
PRINT N'Dropping [dbo].[FK_Agendamento_TestData_Encadeamento]...';


GO
ALTER TABLE [dbo].[Agendamento_TestData] DROP CONSTRAINT [FK_Agendamento_TestData_Encadeamento];


GO
PRINT N'Dropping [dbo].[FK_DataPool_Script_CondicaoScript]...';


GO
ALTER TABLE [dbo].[DataPool] DROP CONSTRAINT [FK_DataPool_Script_CondicaoScript];


GO
PRINT N'Dropping [dbo].[FK_ParametroScript_Script_CondicaoScript]...';


GO
ALTER TABLE [dbo].[ParametroScript] DROP CONSTRAINT [FK_ParametroScript_Script_CondicaoScript];


GO
PRINT N'Dropping [dbo].[FK_Script_CondicaoScript_Ambiente_CondicaoScript]...';


GO
ALTER TABLE [dbo].[Script_CondicaoScript_Ambiente] DROP CONSTRAINT [FK_Script_CondicaoScript_Ambiente_CondicaoScript];


GO
PRINT N'Dropping [dbo].[FK_TestData_Script_CondicaoScript]...';


GO
ALTER TABLE [dbo].[TestData] DROP CONSTRAINT [FK_TestData_Script_CondicaoScript];


GO
PRINT N'Dropping [dbo].[FK_Script_CondicaoScript_Script]...';


GO
ALTER TABLE [dbo].[Script_CondicaoScript] DROP CONSTRAINT [FK_Script_CondicaoScript_Script];


GO
PRINT N'Dropping [dbo].[FK_Script_CondicaoScript_CondicaoScript]...';


GO
ALTER TABLE [dbo].[Script_CondicaoScript] DROP CONSTRAINT [FK_Script_CondicaoScript_CondicaoScript];


GO
PRINT N'Dropping [dbo].[UQ__Script_C__F25B168309746778]...';


GO
ALTER TABLE [dbo].[Script_CondicaoScript] DROP CONSTRAINT [UQ__Script_C__F25B168309746778];


GO
PRINT N'Starting rebuilding table [dbo].[Encadeamento_TestData]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Encadeamento_TestData] (
    [Id]             INT IDENTITY (1, 1) NOT NULL,
    [IdTestData]     INT NOT NULL,
    [IdEncadeamento] INT NOT NULL,
    [Ordem]          INT NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_Encadeamento_TestData1] PRIMARY KEY CLUSTERED ([Id] ASC)
);

ALTER TABLE [dbo].[tmp_ms_xx_Encadeamento_TestData]
    ADD CONSTRAINT [SD_Encadeamento_TestData_7e2683206afd4792a1397fac28bde9c2] DEFAULT 0 FOR [IdEncadeamento];

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Encadeamento_TestData])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_Encadeamento_TestData] ON;
        INSERT INTO [dbo].[tmp_ms_xx_Encadeamento_TestData] ([Id], [IdTestData], [Ordem])
        SELECT   [Id],
                 [IdTestData],
                 [Ordem]
        FROM     [dbo].[Encadeamento_TestData]
        ORDER BY [Id] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_Encadeamento_TestData] OFF;
    END

ALTER TABLE [dbo].[tmp_ms_xx_Encadeamento_TestData] DROP CONSTRAINT [SD_Encadeamento_TestData_7e2683206afd4792a1397fac28bde9c2];

DROP TABLE [dbo].[Encadeamento_TestData];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_Encadeamento_TestData]', N'Encadeamento_TestData';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK_Encadeamento_TestData1]', N'PK_Encadeamento_TestData', N'OBJECT';
...
GO
PRINT N'Creating [dbo].[Encadeamento_TestData].[IX_Encadeamento_TestData_IdTestData]...';


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_Encadeamento_TestData_IdTestData]
    ON [dbo].[Encadeamento_TestData]([IdTestData] ASC);
...
CREATE TABLE [dbo].[tmp_ms_xx_Execucao] (
    ...
    [EnvioTelegram]                    BIT           DEFAULT 1 NOT NULL,
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Execucao] ([Id], [IdScript_CondicaoScript_Ambiente], [IdTestData], [IdStatusExecucao], [IdTipoFaseTeste], [Usuario], [SituacaoAmbiente], [InicioExecucao], [TerminoExecucao], [ToscaInput], [ToscaOutput], [EnvioTelegram], [IdAgendamento])
        SELECT   [Id],
...
GO
PRINT N'Starting rebuilding table [dbo].[Agendamento]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Agendamento] (
    [Id]                 INT           IDENTITY (1, 1) NOT NULL,
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_Agendamento] ON;
        INSERT INTO [dbo].[tmp_ms_xx_Agendamento] ([Id], [RotinaDiaria], [InicioAgendamento], [TerminoAgendamento], [Output])
        SELECT   [Id],
                 [RotinaDiaria],
                 [InicioAgendamento],
                 [TerminoAgendamento],
        ...
        FROM     [dbo].[Agendamento]
        ORDER BY [Id] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_Agendamento] OFF;
    END

DROP TABLE [dbo].[Agendamento];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_Agendamento]', N'Agendamento';
...
GO
PRINT N'Starting rebuilding table [dbo].[Script_CondicaoScript]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Script_CondicaoScript] (
    [Id]                    INT           IDENTITY (1, 1) NOT NULL,
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Script_CondicaoScript])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_Script_CondicaoScript] ON;
        INSERT INTO [dbo].[tmp_ms_xx_Script_CondicaoScript] ([Id], [IdScript], [IdCondicaoScript], [QueryTosca], [ListaExecucaoTosca], [CaminhoArquivoTCS], [DiretorioRelatorio], [TempoEstimadoExecucao], [NomeTecnicoScript])
        SELECT   [Id],
                 [IdScript],
                 [IdCondicaoScript],
                 [QueryTosca],
        ...
        FROM     [dbo].[Script_CondicaoScript]
        ORDER BY [Id] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_Script_CondicaoScript] OFF;
    END

DROP TABLE [dbo].[Script_CondicaoScript];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_Script_CondicaoScript]', N'Script_CondicaoScript';
...
GO
PRINT N'Creating [dbo].[FK_Encadeamento_TestData_TestData]...';


GO
ALTER TABLE [dbo].[Encadeamento_TestData] WITH NOCHECK
    ADD CONSTRAINT [FK_Encadeamento_TestData_TestData] FOREIGN KEY ([IdTestData]) REFERENCES [dbo].[TestData] ([Id]);


GO
PRINT N'Creating [dbo].[FK_Encadeamento_TestData_Encadeamento]...';


GO
ALTER TABLE [dbo].[Encadeamento_TestData] WITH NOCHECK
    ADD CONSTRAINT [FK_Encadeamento_TestData_Encadeamento] FOREIGN KEY ([IdEncadeamento]) REFERENCES [dbo].[Encadeamento] ([Id]);
...
GO
PRINT N'Creating [dbo].[FK_Agendamento_Execucao]...';


GO
ALTER TABLE [dbo].[Execucao] WITH NOCHECK
    ADD CONSTRAINT [FK_Agendamento_Execucao] FOREIGN KEY ([IdAgendamento]) REFERENCES [dbo].[Agendamento] ([Id]);
...
GO
PRINT N'Creating [dbo].[FK_Agendamento_TestData_Encadeamento]...';


GO
ALTER TABLE [dbo].[Agendamento_TestData] WITH NOCHECK
    ADD CONSTRAINT [FK_Agendamento_TestData_Encadeamento] FOREIGN KEY ([IdAgendamento]) REFERENCES [dbo].[Agendamento] ([Id]);
...
GO
ALTER TABLE [dbo].[DataPool] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[ParametroScript] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[Script_CondicaoScript_Ambiente] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[Script_CondicaoScript] WITH NOCHECK
...
END
GO
PRINT N'Refreshing [dbo].[PR_LISTAR_DADOS_EXECUCAO]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[PR_LISTAR_DADOS_EXECUCAO]';


GO
PRINT N'Refreshing [dbo].[PR_LISTAR_ENCADEAMENTO]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[PR_LISTAR_ENCADEAMENTO]';


GO
PRINT N'Refreshing [dbo].[PR_LISTAR_EXECUCAO]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[PR_LISTAR_EXECUCAO]';


GO
PRINT N'Refreshing [dbo].[PR_LISTAR_PARAMETRO_TESTDATA]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[PR_LISTAR_PARAMETRO_TESTDATA]';


GO
PRINT N'Refreshing [dbo].[PR_LISTAR_TEST_DATA]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[PR_LISTAR_TEST_DATA]';


GO
PRINT N'Refreshing [dbo].[PR_LISTAR_TESTDATA_SEM_ENCADEAMENTO]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[PR_LISTAR_TESTDATA_SEM_ENCADEAMENTO]';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '92177cad-6b15-42b2-9a4d-01c1962f6b96')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('92177cad-6b15-42b2-9a4d-01c1962f6b96')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'b28251b9-0f0f-4ef7-9899-b8115aff1f24')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('b28251b9-0f0f-4ef7-9899-b8115aff1f24')
...
GO
ALTER TABLE [dbo].[Encadeamento_TestData] WITH CHECK CHECK CONSTRAINT [FK_Encadeamento_TestData_TestData];

ALTER TABLE [dbo].[Encadeamento_TestData] WITH CHECK CHECK CONSTRAINT [FK_Encadeamento_TestData_Encadeamento];
...
ALTER TABLE [dbo].[Execucao] WITH CHECK CHECK CONSTRAINT [FK_Agendamento_Execucao];

ALTER TABLE [dbo].[TestData] WITH CHECK CHECK CONSTRAINT [FK_TestData_Execucao];

ALTER TABLE [dbo].[Agendamento_TestData] WITH CHECK CHECK CONSTRAINT [FK_Agendamento_TestData_Encadeamento];

ALTER TABLE [dbo].[DataPool] WITH CHECK CHECK CONSTRAINT [FK_DataPool_Script_CondicaoScript];

ALTER TABLE [dbo].[ParametroScript] WITH CHECK CHECK CONSTRAINT [FK_ParametroScript_Script_CondicaoScript];

ALTER TABLE [dbo].[Script_CondicaoScript_Ambiente] WITH CHECK CHECK CONSTRAINT [FK_Script_CondicaoScript_Ambiente_CondicaoScript];

ALTER TABLE [dbo].[TestData] WITH CHECK CHECK CONSTRAINT [FK_TestData_Script_CondicaoScript];

ALTER TABLE [dbo].[Script_CondicaoScript] WITH CHECK CHECK CONSTRAINT [FK_Script_CondicaoScript_Script];

ALTER TABLE [dbo].[Script_CondicaoScript] WITH CHECK CHECK CONSTRAINT [FK_Script_CondicaoScript_CondicaoScript];
